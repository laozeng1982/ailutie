...
public class ImageText extends LinearLayout {
    ...
    private int CHECKED_COLOR = Color.rgb(29, 118, 199); //chose blue
    private int UNCHECKED_COLOR = Color.GRAY;   //natural gray
    ...
    public void setChecked(int itemID) {
        ...
        switch (itemID) {
            case Constant.BTN_FLAG_PLAN:
                checkDrawableId = R.drawable.plan_selected;
                break;
            case Constant.BTN_FLAG_TRAIN:
                checkDrawableId = R.drawable.train_selected;
                break;
            case Constant.BTN_FLAG_COMMUNITY:
                checkDrawableId = R.drawable.community_selected;
                break;
